/*
  # Fix signup errors with SECURITY DEFINER functions

  1. Updates
    - Fix handle_new_user_profile function with proper search_path
    - Fix setup_demo_user_data function with proper search_path
    - Fix add_demo_user_to_project function with proper search_path
    - Fix handle_demo_user_signup function with proper search_path

  2. Security
    - All functions use SECURITY DEFINER with explicit search_path
    - This ensures functions bypass RLS and operate with correct privileges
*/

-- Update handle_new_user_profile function with explicit search_path
...
-- Update setup_demo_user_data function with explicit search_path
...
-- Update add_demo_user_to_project function with explicit search_path
...
-- Update handle_demo_user_signup function with explicit search_path
...
-- Update add_project_owner_as_member function with explicit search_path
